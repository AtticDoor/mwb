...
private var jumpRepeatTime = 0.35;
private var jumpTimeout = 0.15;
private var groundedTimeout = 0.25;

// The camera doesnt start following the target immediately but waits for a split second to avoid too much waving around.
static var lockCameraTimer = 0.0;
...
function Awake ()
{
	...
	walkMaxAnimationSpeed=.9;
	trotMaxAnimationSpeed=1.3;
	runMaxAnimationSpeed=.9;
...
function UpdateSmoothedMovementDirection ()
{
	...
	//		lockCameraTimer = 0.0;
		...
		||Input.GetButton("Run"))		
		{
			...
			if(grounded)_characterState = CharacterState.Running;
		}
		else if (Time.time - trotAfterSeconds > walkTimeStart)
		{
			targetSpeed *= trotSpeed;
			if(grounded)_characterState = CharacterState.Trotting;
		}
		else
		{
			targetSpeed *= walkSpeed;
			if(grounded)_characterState = CharacterState.Walking;
		}
